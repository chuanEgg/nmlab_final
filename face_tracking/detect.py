# Adapted from MediaPipe sample code (https://github.com/google-ai-edge/mediapipe-samples/blob/main/examples/face_detector/raspberry_pi/detect.py)
...
def run(model: str, min_detection_confidence: float,
        min_suppression_threshold: float, width: int, height: int) -> None:
